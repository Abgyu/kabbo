...
export const tiers: PricingTier[] = [
	{
		name: "Qorshaha Premium",
		id: "0",
		price: { "1": "$70", "2": "$600" },
		discountPrice: { "1": "$59", "2": "$499" },
		description: `Gal macluumaadkayaga gaarka ah Is-diiwaangelinta wakhti kasta.`,
		features: [`Helitaanka dhammaan waxyaabaha qiimaha leh`, "Fikirkaaga ka dhiibo", "Like saar qoraalada aad jeceshahay"],
		cta: `Join Us`,
		monthlyUrl:
