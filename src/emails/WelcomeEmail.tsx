...
const WelcomeEmail = ({
	...
	return (
		<Html>
			<Head />
			<Preview>welcome to abdallah cityshoes</Preview>
			<Body style={main}>
				<Container style={container}>
					<Section style={message}>
						...
						/>
						<Heading style={{ ...global.heading }}>Welcome to cityshoes!</Heading>
...
// 					<Section style={global.defaultPadding}>
// 						<Text style={footer.text}>
// 							© {new Date().getFullYear()} cityshoes, Inc. All Rights Reserved.
// 						</Text>
// 					</Section>
// 				</Container>
// 			</Body>
